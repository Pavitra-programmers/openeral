...
type SandboxPolicy struct {
	...
	// FuseMounts contains immutable image-owned FUSE daemon declarations.
	// Nil means no FUSE capability is declared; callers cannot override these
	// values when requesting a sandbox.
...
// FuseMount declares a trusted FUSE daemon and its supervisor-owned mountpoint.
