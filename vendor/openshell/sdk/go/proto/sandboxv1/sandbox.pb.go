...
type SandboxPolicy struct {
	...
	FuseMounts    []*FuseMount `protobuf:"bytes,7,rep,name=fuse_mounts,json=fuseMounts,proto3" json:"fuse_mounts,omitempty"`
...
func (x *SandboxPolicy) GetFuseMounts() []*FuseMount {
	if x != nil {
		return x.FuseMounts
	}
	return nil
...
type FuseMount struct {
	...
	FsName string `protobuf:"bytes,4,opt,name=fs_name,json=fsName,proto3" json:"fs_name,omitempty"`
	// Whether non-owner users may access the mount.
	AllowOther bool `protobuf:"varint,5,opt,name=allow_other,json=allowOther,proto3" json:"allow_other,omitempty"`
	// Maximum time to wait for the daemon FUSE INIT readiness signal.
	StartupTimeoutSeconds uint32 `protobuf:"varint,6,opt,name=startup_timeout_seconds,json=startupTimeoutSeconds,proto3" json:"startup_timeout_seconds,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *FuseMount) Reset() {
	*x = FuseMount{}
...
func (x *FuseMount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FuseMount) ProtoMessage() {}

func (x *FuseMount) ProtoReflect() protoreflect.Message {
	mi := &file_sandbox_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FuseMount.ProtoReflect.Descriptor instead.
func (*FuseMount) Descriptor() ([]byte, []int) {
	return file_sandbox_proto_rawDescGZIP(), []int{1}
}

func (x *FuseMount) GetBinary() string {
	if x != nil {
		return x.Binary
	}
	return ""
...
func (x *FuseMount) GetArgs() []string {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *FuseMount) GetMountpoint() string {
	if x != nil {
		return x.Mountpoint
	}
	return ""
...
func (x *FuseMount) GetFsName() string {
	if x != nil {
		return x.FsName
	}
	return ""
...
func (x *FuseMount) GetAllowOther() bool {
	if x != nil {
		return x.AllowOther
	}
	return false
...
func (x *FuseMount) GetStartupTimeoutSeconds() uint32 {
	if x != nil {
...
const file_sandbox_proto_rawDesc = "" +
	"\n" +
	"\rsandbox.proto\x12\x14openshell.sandbox.v1\x1a\x1cgoogle/protobuf/struct.proto\"\xea\x05\n" +
	...
	"\vfuse_mounts\x18\a \x03(\v2\x1f.openshell.sandbox.v1.FuseMountR\n" +
	"fuseMounts\x1ak\n" +
	...
	"\x05value\x18\x02 \x01(\v2-.openshell.sandbox.v1.NetworkMiddlewareConfigR\x05value:\x028\x01\"\xc9\x01\n" +
	"\tFuseMount\x12\x16\n" +
	"\x06binary\x18\x01 \x01(\tR\x06binary\x12\x12\n" +
	"\x04args\x18\x02 \x03(\tR\x04args\x12\x1e\n" +
	"\n" +
	"mountpoint\x18\x03 \x01(\tR\n" +
	"mountpoint\x12\x17\n" +
	"\afs_name\x18\x04 \x01(\tR\x06fsName\x12\x1f\n" +
	"\vallow_other\x18\x05 \x01(\bR\n" +
	"allowOther\x126\n" +
	"\x17startup_timeout_seconds\x18\x06 \x01(\rR\x15startupTimeoutSeconds\"w\n" +
...
var file_sandbox_proto_goTypes = []any{
	...
	(*FuseMount)(nil),                   // 3: openshell.sandbox.v1.FuseMount
	...
	(*NetworkPolicyRule)(nil),           // 7: openshell.sandbox.v1.NetworkPolicyRule
	(*NetworkMiddlewareConfig)(nil),     // 8: openshell.sandbox.v1.NetworkMiddlewareConfig
	(*MiddlewareEndpointSelector)(nil),  // 9: openshell.sandbox.v1.MiddlewareEndpointSelector
	(*NetworkCredentialBinding)(nil),    // 10: openshell.sandbox.v1.NetworkCredentialBinding
	(*NetworkEndpoint)(nil),             // 11: openshell.sandbox.v1.NetworkEndpoint
	(*McpOptions)(nil),                  // 12: openshell.sandbox.v1.McpOptions
	(*GraphqlOperation)(nil),            // 13: openshell.sandbox.v1.GraphqlOperation
	(*L7DenyRule)(nil),                  // 14: openshell.sandbox.v1.L7DenyRule
	(*L7Rule)(nil),                      // 15: openshell.sandbox.v1.L7Rule
	(*L7Allow)(nil),                     // 16: openshell.sandbox.v1.L7Allow
	(*L7QueryMatcher)(nil),              // 17: openshell.sandbox.v1.L7QueryMatcher
	(*NetworkBinary)(nil),               // 18: openshell.sandbox.v1.NetworkBinary
	(*GetSandboxConfigRequest)(nil),     // 19: openshell.sandbox.v1.GetSandboxConfigRequest
	(*GetGatewayConfigRequest)(nil),     // 20: openshell.sandbox.v1.GetGatewayConfigRequest
	(*GetGatewayConfigResponse)(nil),    // 21: openshell.sandbox.v1.GetGatewayConfigResponse
	(*SettingValue)(nil),                // 22: openshell.sandbox.v1.SettingValue
	(*EffectiveSetting)(nil),            // 23: openshell.sandbox.v1.EffectiveSetting
...
var file_sandbox_proto_depIdxs = []int32{
	...
	3,  // 5: openshell.sandbox.v1.SandboxPolicy.fuse_mounts:type_name -> openshell.sandbox.v1.FuseMount
	11, // 6: openshell.sandbox.v1.NetworkPolicyRule.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	18, // 7: openshell.sandbox.v1.NetworkPolicyRule.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	35, // 8: openshell.sandbox.v1.NetworkMiddlewareConfig.config:type_name -> google.protobuf.Struct
	9,  // 9: openshell.sandbox.v1.NetworkMiddlewareConfig.endpoints:type_name -> openshell.sandbox.v1.MiddlewareEndpointSelector
	15, // 10: openshell.sandbox.v1.NetworkEndpoint.rules:type_name -> openshell.sandbox.v1.L7Rule
	14, // 11: openshell.sandbox.v1.NetworkEndpoint.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	28, // 12: openshell.sandbox.v1.NetworkEndpoint.graphql_persisted_queries:type_name -> openshell.sandbox.v1.NetworkEndpoint.GraphqlPersistedQueriesEntry
	12, // 13: openshell.sandbox.v1.NetworkEndpoint.mcp:type_name -> openshell.sandbox.v1.McpOptions
	10, // 14: openshell.sandbox.v1.NetworkEndpoint.credential_binding:type_name -> openshell.sandbox.v1.NetworkCredentialBinding
	29, // 15: openshell.sandbox.v1.L7DenyRule.query:type_name -> openshell.sandbox.v1.L7DenyRule.QueryEntry
	30, // 16: openshell.sandbox.v1.L7DenyRule.params:type_name -> openshell.sandbox.v1.L7DenyRule.ParamsEntry
	16, // 17: openshell.sandbox.v1.L7Rule.allow:type_name -> openshell.sandbox.v1.L7Allow
	31, // 18: openshell.sandbox.v1.L7Allow.query:type_name -> openshell.sandbox.v1.L7Allow.QueryEntry
	32, // 19: openshell.sandbox.v1.L7Allow.params:type_name -> openshell.sandbox.v1.L7Allow.ParamsEntry
	33, // 20: openshell.sandbox.v1.GetGatewayConfigResponse.settings:type_name -> openshell.sandbox.v1.GetGatewayConfigResponse.SettingsEntry
	22, // 21: openshell.sandbox.v1.EffectiveSetting.value:type_name -> openshell.sandbox.v1.SettingValue
	...
	34, // 24: openshell.sandbox.v1.GetSandboxConfigResponse.settings:type_name -> openshell.sandbox.v1.GetSandboxConfigResponse.SettingsEntry
	1,  // 25: openshell.sandbox.v1.GetSandboxConfigResponse.policy_source:type_name -> openshell.sandbox.v1.PolicySource
	25, // 26: openshell.sandbox.v1.GetSandboxConfigResponse.supervisor_middleware_services:type_name -> openshell.sandbox.v1.SupervisorMiddlewareService
	7,  // 27: openshell.sandbox.v1.SandboxPolicy.NetworkPoliciesEntry.value:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	8,  // 28: openshell.sandbox.v1.SandboxPolicy.NetworkMiddlewaresEntry.value:type_name -> openshell.sandbox.v1.NetworkMiddlewareConfig
	13, // 29: openshell.sandbox.v1.NetworkEndpoint.GraphqlPersistedQueriesEntry.value:type_name -> openshell.sandbox.v1.GraphqlOperation
	17, // 30: openshell.sandbox.v1.L7DenyRule.QueryEntry.value:type_name -> openshell.sandbox.v1.L7QueryMatcher
	17, // 31: openshell.sandbox.v1.L7DenyRule.ParamsEntry.value:type_name -> openshell.sandbox.v1.L7QueryMatcher
	17, // 32: openshell.sandbox.v1.L7Allow.QueryEntry.value:type_name -> openshell.sandbox.v1.L7QueryMatcher
	17, // 33: openshell.sandbox.v1.L7Allow.ParamsEntry.value:type_name -> openshell.sandbox.v1.L7QueryMatcher
	22, // 34: openshell.sandbox.v1.GetGatewayConfigResponse.SettingsEntry.value:type_name -> openshell.sandbox.v1.SettingValue
	23, // 35: openshell.sandbox.v1.GetSandboxConfigResponse.SettingsEntry.value:type_name -> openshell.sandbox.v1.EffectiveSetting
