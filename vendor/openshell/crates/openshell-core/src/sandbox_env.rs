...
/// Driver-owned marker indicating that the public sandbox request included
/// the FUSE resource requirement.
///
/// The supervisor validates it against static image policy and never forwards
/// it to workload children.
pub const FUSE_REQUESTED: &str = "OPENSHELL_FUSE_REQUESTED";

/// Prefix reserved for supervisor-mapped FUSE and readiness descriptors.
pub const FUSE_FD_PREFIX: &str = "OPENSHELL_FUSE_FD_";
