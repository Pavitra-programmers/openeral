...
/// Supervisor exit code reserved for a failed critical child such as a FUSE daemon.
///
/// Compute drivers use this value to distinguish a recoverable service restart
/// from a generic workload/container failure.
pub const CRITICAL_SERVICE_EXIT_CODE: i32 = 75;
