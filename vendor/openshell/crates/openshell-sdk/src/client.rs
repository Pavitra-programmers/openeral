...
fn create_sandbox_request(spec: SandboxSpec) -> proto::CreateSandboxRequest {
    ...
    let resource_requirements = (gpu || fuse).then_some(proto::ResourceRequirements {
        gpu: gpu.then_some(proto::GpuResourceRequirements { count: None }),
        fuse: fuse.then_some(proto::FuseResourceRequirements {}),
    });
