...
use openshell_core::proto::{
    ...
    ExposeServiceRequest, FuseResourceRequirements, GetCurrentUserRequest, GetDraftHistoryRequest,
...
pub struct SandboxCreateConfig<'a> {
    ...
    pub fuse_requirements: Option<FuseResourceRequirements>,
...
pub async fn sandbox_create(
    ...
    let resource_requirements = (gpu_requirements.is_some() || fuse_requirements.is_some())
        .then_some(ResourceRequirements {
            gpu: gpu_requirements,
            fuse: fuse_requirements,
        });
