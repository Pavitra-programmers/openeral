...
use openshell_core::proto::{FuseResourceRequirements, GpuResourceRequirements};
...
enum SandboxCommands {
    ...
    Create {
        ...
        /// Request the immutable FUSE mount declared by the sandbox image policy.
        #[arg(long)]
        fuse: bool,
        ...
        Some(Commands::Sandbox {
            ...
            match command {
                SandboxCommands::Create {
                    ...
                    let fuse_requirements = fuse.then_some(FuseResourceRequirements {});
