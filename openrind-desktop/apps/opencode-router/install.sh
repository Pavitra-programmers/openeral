...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/openrind/openrind-desktop.git}"
OPENCODE_ROUTER_INSTALL_DIR="${OPENCODE_ROUTER_INSTALL_DIR:-$HOME/.openrind-desktop/opencode-router/openrind-desktop}"
...
Environment variables:
  OPENCODE_ROUTER_INSTALL_DIR  Install directory (default: ~/.openrind-desktop/opencode-router/openrind-desktop)
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/openrind/openrind-desktop.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/openrind/openrind-desktop/dev/apps/opencode-router/install.sh | bash
EOF
}
