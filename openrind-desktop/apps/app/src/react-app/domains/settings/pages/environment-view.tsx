...
const PREDEFINED_CREDENTIALS: PredefinedCredentialDef[] = [
  ...
  },
  {
    ...
    description:
      "Optional OpenRouter smoke-test key. Claude Code uses OpenRouter's Anthropic-compatible endpoint and openrouter/free; the sandbox receives only a gateway-resolved placeholder.",
