/**
 * Release-channel concept for Openrind Desktop desktop builds.
 *
...
export const STABLE_UPDATER_ENDPOINT =
  "https://github.com/openrind/openrind-desktop/releases/latest/download/latest.json";

/** Alpha channel's Tauri updater manifest URL (macOS-only, rolling). */
export const ALPHA_UPDATER_ENDPOINT =
  "https://github.com/openrind/openrind-desktop/releases/download/alpha-macos-latest/latest.json";
