...
VERSION="${TAG#v}"
ASSET_NAME_AMD64="${AUR_ASSET_NAME:-openrind-desktop-desktop-linux-amd64.deb}"
ASSET_NAME_ARM64="openrind-desktop-desktop-linux-arm64.deb"
ASSET_URL_AMD64="https://github.com/openrind/openrind-desktop/releases/download/${TAG}/${ASSET_NAME_AMD64}"
ASSET_URL_ARM64="https://github.com/openrind/openrind-desktop/releases/download/${TAG}/${ASSET_NAME_ARM64}"
