...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "openrind-desktop-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "openrind/openrind-desktop"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "openrind-desktop-download-stats",
  }
