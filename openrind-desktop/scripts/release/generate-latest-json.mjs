...
function parseArgs(argv) {
  const options = {
    ...
    repo: process.env.GITHUB_REPOSITORY || "openrind/openrind-desktop",
    output: "latest.json",
...
function updaterPlatformKeys(assetName) {
  if (!assetName.startsWith("openrind-desktop-desktop-")) return [];

  const stem = assetName.slice("openrind-desktop-desktop-".length);
...
function authHeaders() {
  const headers = {
    ...
    "User-Agent": "openrind-desktop-release-latest-json",
  };
