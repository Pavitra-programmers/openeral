...
description: "How to connect a custom MCP server with openrind-desktop"
---

Connecting a custom MCP server with openrind-desktop takes four clicks.
...
Once in their Oath page, you should just continue with the registration or custom setup. It should redirect back to openrind-desktop. Feel free to [open an issue](https://github.com/openrind/openrind-desktop/issues/) if you require a custom MCP that we currently do not support.
