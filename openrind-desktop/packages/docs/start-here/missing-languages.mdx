...
description: "See which OpenrindDesktop languages ship today and help us improve them."
---

OpenrindDesktop already ships with a growing set of languages, and we want to keep expanding that list.
...
<Frame>
  <iframe
    ...
    title="OpenrindDesktop missing languages overview"
...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/openrind/openrind-desktop/tree/dev/apps/app/src/i18n/locales).
...
If you want to add a new language to OpenrindDesktop, the basic file changes are:
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/openrind/openrind-desktop/issues/1385).
